...
function mouseEnterMouse1(){
    document.getElementById("github").style = "color: blueviolet";
}
...
function mouseEnterMouse2(){
    document.getElementById("linkedin").style = "color: blueviolet";
}
...
function verificarSePassou(mediaSemestral){
    mostrarAviso();
    if(mediaSemestral < 7){
        document.getElementById("aviso").textContent = "Você vai para o Exame";
...
function verificarSePegouDp(mediaFinal){
    mostrarAviso();
    if(mediaFinal < 5){
        document.getElementById("aviso").textContent = "Infelismente você ficou de DP😞";
        avisoNotaFinal(mediaFinal);
    }else{
        document.getElementById("aviso").textContent = "Ufaa você escapou da DP😄";
        avisoNotaFinal(mediaFinal);
